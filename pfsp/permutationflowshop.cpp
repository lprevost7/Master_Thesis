...
// emili::pfsp::PermutationFlowShopSolution::setSizeSol
/** New 27/03 */
void emili::pfsp::PermutationFlowShopSolution::setSolution(std::vector <int>& sol)
{
    this->solution = sol;
}
std::vector<int> emili::pfsp::PermutationFlowShopSolution::getsolvector()
{
    return this->solution;
}
...
/** NEW method PFSP_TPLS */
// int emili::pfsp::PFSP_TPLS::computeObjectiveFunction2(std::vector<int> &partial_solution, double lambda)
// {
//     return lambda * instance.computeMS(partial_solution) +  lambda * instance.computeTCT(partial_solution);
// }

// int emili::pfsp::PFSP_TPLS::computeObjectiveFunction2(std::vector<int> &partial_solution, int size, double lambda)
// {
//     return lambda * instance.computeMS(partial_solution,size) +  lambda * instance.computeTCT(partial_solution,size);
// }

void  emili::pfsp::PermutationFlowShop::setLambda(double newlambda)
{
    this->lambda = newlambda;
}

double emili::pfsp::PermutationFlowShop::getLambda()
{
    return this->lambda;
}

/** NEW */
int emili::pfsp::PFSP_TPLS::computeObjectiveFunction(std::vector<int> &partial_solution)
{
    // double lambda = 0.5;
    // std::cout << "MS: " << instance.computeMS(partial_solution) << " TCT: " << instance.computeTCT(partial_solution) << std::endl;
    // for(int i=0; i<partial_solution.size(); i++)
    // {
    //     std::cout << partial_solution[i] << " ";
    // }
    return lambda*problemObject1->computeObjectiveFunction(partial_solution) + (1-lambda)*problemObject2->computeObjectiveFunction(partial_solution);
    // return lambda*instance.computeTCT(partial_solution) + (1-lambda)*instance.computeMS(partial_solution);
}

int emili::pfsp::PFSP_TPLS::computeObjectiveFunction(std::vector<int> &partial_solution, int size)
{
    // return 0.5*instance.computeMS(partial_solution,size) + 0.5*instance.computeTCT(partial_solution,size);
    return 0;
}

int emili::pfsp::PFSP_TPLS::getValueSolutionProblem1(std::vector<int> &partial_solution)
{
    return problemObject1->computeObjectiveFunction(partial_solution);
}

int emili::pfsp::PFSP_TPLS::getValueSolutionProblem2(std::vector<int> &partial_solution)
{
    return problemObject2->computeObjectiveFunction(partial_solution);
}

int emili::pfsp::PFSP_TPLS::computeObjectiveFunction(double lambda)
{
    return 0;
}
