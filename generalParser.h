...
#define COMPONENT_GA_SELECTION                  0xD1
#define COMPONENT_GA_CROSSOVER                  0xD2
#define COMPONENT_GA_MUTATION                   0xD3
...
public:
    ...
    /** New */
    virtual emili::Problem* openInstance(bool multiobj) {return nullptr;}
    virtual emili::Problem* openInstance2() {return nullptr;}
    virtual emili::Problem* openInstance(emili::Problem* instance1, emili::Problem* instance2 ) {return nullptr;}
    /**
    ...
    virtual emili::GASelection*  buildGASelection()  { return nullptr; }
    virtual emili::GACrossover*  buildGACrossover()  { return nullptr; }
    virtual emili::GAMutation*   buildGAMutation()   { return nullptr; }
...
protected:
    ...
    /**
     * @brief instance
     *         The problem instance1
     */
    emili::Problem* instance1;

    /**
     * @brief instance
     *         The problem instance2
     */
    emili::Problem* instance2;
    /**
     * @brief typeName
     *          Returns a string that describe type.
     * @param type
