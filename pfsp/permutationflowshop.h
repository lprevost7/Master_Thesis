...
public:
    ...
    */
    ...
    // /** NEW for multiobjective */
    int computeObjectiveFunction(double lambda);
    /** NEW for multiobjective */
    int computeObjectiveFunction2(std::vector<int> &partial_solution, double lambda);
    int computeObjectiveFunction2(std::vector<int> &partial_solution, int size, double lambda);
...
// /** NEW Make Multiobjectif MS_TCT */ 
// class PFSP_TPLS: public PermutationFlowShop
// {
// public:
//     PFSP_TPLS(PfspInstance& problem_instance):PermutationFlowShop(problem_instance) { }
//     PFSP_TPLS(char* instance_path):PermutationFlowShop(instance_path) { }
//     int computeObjectiveFunction2(std::vector<int> &partial_solution,int size, double lambda);
//     int computeObjectiveFunction2(std::vector<int> &partial_solution, double lambda);
// };
...
//     // virtual int computeObjectiveFunction(std::vector< int > & partial_solution, double lambda);
//     int computeObjectiveFunction2(std::vector<int> &partial_solution, double lambda);
...
{
public:
    PermutationFlowShop *problemObject1;
    PermutationFlowShop *problemObject2;
    PFSP_TPLS(PfspInstance problem_instance, Problem *problemObject1, Problem *problemObject2):
        PermutationFlowShop(problem_instance),
        problemObject1(static_cast<PermutationFlowShop*>(problemObject1)),
        problemObject2(static_cast<PermutationFlowShop*>(problemObject2)) { }
    PFSP_TPLS(PfspInstance& problem_instance):PermutationFlowShop(problem_instance) { }
    PFSP_TPLS(char* instance_path):PermutationFlowShop(instance_path) { }
    ...
    int  getValueSolutionProblem1(std::vector<int> &partial_solution);
    int  getValueSolutionProblem2(std::vector<int> &partial_solution);
...
/** New 10/04 
 * Make Multiobjectif PLS
 *  
 * */ 
class PFSP_PLS: public PFSP_TPLS
{
public:
    // PermutationFlowShop *problemObject1;
    // PermutationFlowShop *problemObject2;
    // PFSP_PLS(PfspInstance problem_instance, Problem *problemObject1, Problem *problemObject2):
    //     // PermutationFlowShop(problem_instance),
    //     // problemObject1(static_cast<PermutationFlowShop*>(problemObject1)),
    //     // problemObject2(static_cast<PermutationFlowShop*>(problemObject2)) { }
    //     PFSP_TPLS(problem_instance, problemObject1, problemObject2) {}
    PFSP_PLS(PfspInstance& problem_instance):PFSP_TPLS(problem_instance) { }
    PFSP_PLS(char* instance_path):PFSP_TPLS(instance_path) { }
    PFSP_PLS(PfspInstance inst, Problem* obj1, Problem* obj2)
        : PFSP_TPLS(inst, obj1, obj2) {}
    
    // virtual int computeObjectiveFunction(std::vector<int> &partial_solution);
    // virtual int computeObjectiveFunction(std::vector<int>& partial_solution) override;
    // virtual int computeObjectiveFunction(std::vector<int>& partial_solution, int size) override;
...
class PFSP_TPPLS : public PFSP_TPLS {
public:
    PFSP_TPPLS(PfspInstance& inst) : PFSP_TPLS(inst) {}
    PFSP_TPPLS(char* path) : PFSP_TPLS(path) {}
    PFSP_TPPLS(PfspInstance inst, Problem* obj1, Problem* obj2)
        : PFSP_TPLS(inst, obj1, obj2) {}
};
